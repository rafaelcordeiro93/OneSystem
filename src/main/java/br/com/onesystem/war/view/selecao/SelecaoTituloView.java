...
public class SelecaoTituloView extends BasicCrudMBImpl<Titulo> implements Serializable {
    ...
    @PostConstruct
    public void init() {
        beans = service.buscarTitulos();
    }

    public void abrirDialogo() {
        exibirNaTela("financeiro/selecao/selecaoTitulo");
    }
