...
@Named
@ViewScoped
public class SelecaoOperacaoCondicionalView extends BasicCrudMBImpl<Operacao> implements Serializable {
    ...
    public void buscarDados() {
        beans = operacaoDAO.porTipoDeOperacao(TipoOperacao.CONDICIONAL).listaDeResultados(manager);
    }
