...
//    private CobrancaBV parcelaSelecionada;
//    private CobrancaBV parcelaBV;
...
//                notaEmitida.setItens(new ArrayList<ItemDeNota>());
//                notaEmitida.setEmissao(new Date());
//                for (ItemDeNota ie : itensEmitidos) {
//                    ItemDeNotaBV ieBV = new ItemDeNotaBV(ie);
//                    notaEmitida.getItens().add(ieBV.construir());
//                }
//                validaAFaturar();
//            } else {
...
//        try {
//            List<Cobranca> parcelasBV = new ArrayList<>();
//
...
//        if (ne.getCobrancas() != null) {
//            for (Cobranca t : ne.getCobrancas()) {
...
//
//    /**
//     * Prepara inclusão do ItemDeNota na tabela e prepara a inclusão dos dados
// no estoque.
//     *
...
//        for (ItemDeNota ie : ne.getItensEmitidos()) {
...
//    }
//
//    private List<Estoque> criarBaixaDeEstoque(List<QuantidadeDeItemPorDeposito> lista) throws DadoInvalidoException {
//        List<Estoque> estoquesBV = new ArrayList<>();
//        try {
//            for (QuantidadeDeItemPorDeposito q : lista) {
...
//            ItemDeNota ie = itemEmitido.construirComId();
//
...
//        for (ItemDeNota i : itensEmitidos) {
...
//        parcelaBV = new CobrancaBV(parcelaSelecionada);
...
//      //  parcelaBV = new CobrancaBV(parcela);
//       // RequestContext req = RequestContext.getCurrentInstance();
...
//
//            notaEmitidaSelecionada.getCobrancas().forEach(i -> {
//                parcelas.add(new CobrancaBV(i));
//            });
//
//            // itemEmitido = new ItemDeNotaBV();
//            creditoBV = new CreditoBV();
...
//        Long id = (long) 1;
//        if (!itensEmitidos.isEmpty()) {
//            for (ItemDeNota dp : itensEmitidos) {
//                if (dp.getId() >= id) {
//                    id = dp.getId() + 1;
//                }
//            }
...
//    }
//
//    public CobrancaBV getParcelaSelecionada() {
//        return parcelaSelecionada;
//    }
//
//    public void setParcelaSelecionada(CobrancaBV parcelaSelecionada) {
//        this.parcelaSelecionada = parcelaSelecionada;
//    }
//
//    public CobrancaBV getParcelaBV() {
//        return parcelaBV;
//    }
//
//    public void setParcelaBV(CobrancaBV parcelaBV) {
