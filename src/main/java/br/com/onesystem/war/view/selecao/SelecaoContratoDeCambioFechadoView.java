...
@ManagedBean
@ViewScoped
public class SelecaoContratoDeCambioFechadoView implements Serializable {
    ...
    @PostConstruct
    public void init() {
        contratoDeCambioLista = service.buscarContratosFechadosParaCambio();
    }
    ...
    public void abrirDialogo() {
        ...
        RequestContext.getCurrentInstance().openDialog("selecao/selecaoContratoDeCambioFechado", opcoes, null);
    }
