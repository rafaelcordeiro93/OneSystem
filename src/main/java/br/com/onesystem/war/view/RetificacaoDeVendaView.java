...
public class RetificacaoDeVendaView extends BasicMBImpl<NotaEmitida, NotaEmitidaBV> implements Serializable {
    ...
    public void selecionar(SelectEvent event) {
        try {
            ...
            if (obj instanceof NotaEmitida && "abreDialogoCotacao-btn".equals(idComponent)) {
                this.nota = (NotaEmitida) obj;
                this.notaBV = new NotaEmitidaBV(nota);
                update();
    ...
    public NotaEmitidaBV getNotaBV() {
        return notaBV;
    }

    public void setNotaBV(NotaEmitidaBV notaBV) {
        this.notaBV = notaBV;
    }
