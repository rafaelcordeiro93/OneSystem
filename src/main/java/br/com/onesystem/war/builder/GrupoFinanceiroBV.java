...
public class GrupoFinanceiroBV implements Serializable, BuilderView<GrupoFinanceiro> {
    
    private static final long serialVersionUID = 6686124108160060627L;
    
    private Long id;
    private String nome;
    private NaturezaFinanceira naturezaFinanceira = NaturezaFinanceira.DESPESA;
