...
public class RelatorioDeContaAPagarBV implements Serializable {
    ...
    private EstadoConta estadoConta = EstadoConta.PAGO;
    private TipoBusca tipoBusca = TipoBusca.PAGAMENTO;
