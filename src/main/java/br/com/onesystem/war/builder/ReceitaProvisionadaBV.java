...
public class ReceitaProvisionadaBV implements Serializable, BuilderView<ReceitaProvisionada> {
    ...
    public ReceitaProvisionadaBV(ReceitaProvisionada receitaProvisionadaSelecionada) {
        ...
        this.operacaoFinanceira = receitaProvisionadaSelecionada.getOperacaoFinanceira();
    }
    
    public ReceitaProvisionadaBV(Long id, Pessoa pessoa, TipoReceita receita, BigDecimal valor,
            Date vencimento, Date emissao, String historico, Cotacao cotacao, Date referencia, OperacaoFinanceira operacaoFinanceira) {
    ...
    public ReceitaProvisionada construir() throws DadoInvalidoException {
        return new ReceitaProvisionadaBuilder().comPessoa(pessoa).comReceita(receita)
                ...
                .comCotacao(cotacao).comOperacaoFinanceira(operacaoFinanceira).construir();
    }
