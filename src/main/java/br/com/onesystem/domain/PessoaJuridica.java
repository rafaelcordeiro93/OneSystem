...
public class PessoaJuridica extends Pessoa {
    ...
    public PessoaJuridica(String fantasia, Long ID, String nome, TipoPessoa tipo, String ruc, boolean ativo, String direcao, String bairro, boolean categoriaCliente, boolean categoriaFornecedor, boolean categoriaVendedor, boolean categoriaTransportador, Double desconto, Date cadastro, String observacao, String fiador, Cep cep, String telefone, String email, String contato) throws DadoInvalidoException {
        super(ID, nome, tipo, ruc, ativo, direcao, bairro, categoriaCliente, categoriaFornecedor, categoriaVendedor, categoriaTransportador, desconto, cadastro, observacao, fiador, cep, telefone, email, contato);
