...
public class PessoaFisica extends Pessoa {
    ...
    public PessoaFisica(String CI, Date nascimento, Long ID, String nome, TipoPessoa tipo, String ruc, boolean ativo, String direcao, String bairro, boolean categoriaCliente, boolean categoriaFornecedor, boolean categoriaVendedor, boolean categoriaTransportado, String conjuge, Double desconto, Date cadastro, String observacao, String fiador, Cidade cidade, String telefone, String email, String contato) throws DadoInvalidoException {
        super(ID, nome, tipo, ruc, ativo, direcao, bairro, categoriaCliente, categoriaFornecedor, categoriaVendedor, categoriaTransportado, desconto, cadastro, observacao, fiador, cidade, telefone, email, contato);
        this.CI = CI;
